...
public class AddressBookService {
	...
	private Person getAddressBookData(String firstName) {
		return this.addressBookList.stream().filter(n -> n.firstName.equals(firstName)).findFirst().orElse(null);
	}
	...
	public void addNewContact(String firstName, String lastName, String address, String city, String state, String zip,
		...
		addressBookList
				.add(addressBookDBService.addNewContact(firstName, lastName, address, city, state, zip, phno, emailId));
	}
